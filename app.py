...
# Clear chat if context changes (PM UX decision)
...
if prompt := st.chat_input("Make your pitch..."):
    ...
    # System prompt to enforce the persona (The PM magic is tuning this string)
    system_prompt = f"""
    ...
    with st.chat_message("assistant"):
        message = client.messages.create(
            model="claude-3-haiku-20240307", # Haiku is fast and cheap for MVPs
            max_tokens=300,
